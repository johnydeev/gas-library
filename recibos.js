 ...
 **/
function crearRecibosMasivos(CARPETA,SPREADSHEET,HOJA_RECIBO,HOJA_MAILS,CANT_UF,CELDA_NOMBRE,CELDA_UF,CELDA_MES){
    ...
    for(let i = 0 ; i < CANT_UF ; i++){
      ...
      let nombreUF = HOJA_RECIBO.getRange(CELDA_NOMBRE).getValue()
 ...
 **/
function reiniciarRecibosMasivos(CARPETA,SPREADSHEET,HOJA_RECIBO,HOJA_MAILS,CANT_UF,CELDA_NOMBRE,CELDA_UF,UF){
